...
#[component]
pub fn EmptyMagnifyingGlassIllustration() -> Element {
    rsx! {
        svg {
            width: "150",
            height: "100",
            view_box: "25 50 200 100",
            fill: "none",
            ...
            path {
                ...
                class: "stroke-neutral-600 fill-neutral-300",
                stroke_width: "2.5",
            }
            path {
                fill_rule: "evenodd",
            ...
            path {
                ...
                class: "stroke-neutral-600 fill-neutral-200",
                stroke_width: "2.5",
            }
            path {
                d: "M158 133L169 144",
